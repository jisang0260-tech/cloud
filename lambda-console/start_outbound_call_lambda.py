...
AUTO_CALL_STATUS_ATTR = os.getenv("AUTO_CALL_STATUS_ATTR", "autoCallEnabled")
AUTO_CALL_STATUS_VALUE = os.getenv("AUTO_CALL_STATUS_VALUE", "true")
PREFERRED_TIME_ATTR = os.getenv("PREFERRED_TIME_ATTR", "autoCallTime")
